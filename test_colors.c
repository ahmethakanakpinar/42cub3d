...
/*   Updated: 2025/10/14 17:09:48 by aakpinar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    printf("  RGB Values: R=%d, G=%d, B=%d\n", 
        ...
        (game->map.floor_color >> 8) & 0xFF,
        game->map.floor_color & 0xFF);
    printf("  Hex: 0x%06X\n", game->map.floor_color);
    
    printf("\nCeiling Color (C 225,30,0):\n");
    printf("  RGB Values: R=%d, G=%d, B=%d\n",
        (game->map.ceiling_color >> 16) & 0xFF,
        (game->map.ceiling_color >> 8) & 0xFF,
        game->map.ceiling_color & 0xFF);
